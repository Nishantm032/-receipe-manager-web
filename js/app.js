  ...
  if (!Array.isArray(recipes) || recipes.length === 0) {
    const initial = [
      ...
      },
      {
        ...
        title: "Pav Bhaji",
        description:
          "Spiced mashed vegetables served with buttered bread rolls.",
        ingredients: [
          "2–3 potatoes",
        ...
        steps: [
          "Boil potatoes and mixed vegetables until soft.",
          "Mash the boiled vegetables well and keep aside.",
          "Heat 1 tbsp butter in a pan and sauté onions until golden brown.",
          "Add green chillies and ginger-garlic paste, cook for 1–2 minutes.",
          "Add chopped tomatoes, salt, and pav bhaji masala. Cook until tomatoes soften.",
          "Add mashed vegetables to the pan, mix thoroughly.",
          "Simmer on low flame for 8–10 minutes, stirring occasionally.",
          "Adjust consistency by adding a little water if needed.",
          "Add remaining butter and chopped coriander leaves. Mix well.",
          "Toast pav bread on a tawa with butter and serve hot with bhaji.",
        ],
        prepTime: 45,
        difficulty: "Medium",
...

      {
        id: Date.now() + 8,
        title: "Gulab Jamun",
        description: "Soft, spongy milk-based sweet soaked in sugar syrup.",
        ingredients: [
          "1 cup milk powder",
        ...
        steps: [
          "Mix milk powder, maida, ghee, and milk to form a smooth dough.",
          "Divide the dough into small smooth balls, ensuring no cracks.",
          "Heat oil/ghee in a deep frying pan on medium flame.",
          "Fry the balls slowly, stirring continuously until golden brown.",
          "Prepare sugar syrup by dissolving sugar in water and boiling for 5 minutes.",
          "Add cardamom powder and rose water to the syrup.",
          "Reduce flame and add fried balls into the warm syrup.",
          "Let them soak for at least 30 minutes for best taste.",
          "Gently stir the syrup occasionally to ensure even soaking.",
          "Serve warm or chilled, garnished with chopped nuts if desired.",
        ],
        prepTime: 50,
        difficulty: "Medium",
...

      {
        id: Date.now() + 9,
        title: "Rajma Masala",
        description: "Kidney beans cooked in flavorful onion-tomato gravy.",
        ingredients: [
        ...
        steps: [
          "Soak kidney beans overnight in enough water.",
          "Drain and rinse beans, then boil them until soft in a pressure cooker.",
          "Heat oil in a pan, add cumin seeds and sauté until fragrant.",
          "Add chopped onions and cook until golden brown.",
          "Add ginger-garlic paste and sauté for 1–2 minutes.",
          "Add chopped tomatoes, turmeric, coriander powder, red chilli powder, and salt. Cook until tomatoes soften.",
          "Add boiled rajma along with some cooking water to adjust consistency.",
          "Simmer on low flame for 10–15 minutes, stirring occasionally.",
          "Add garam masala and chopped coriander leaves. Mix well.",
          "Serve hot with steamed rice or roti, garnish with extra coriander if desired.",
        ],
        prepTime: 55,
        difficulty: "Medium",
